...
- Giúp tránh “rung PWM” liên tục khi nhiệt độ gần bằng mục tiêu
- Nếu không có deadband, quạt/hệ thống sẽ giật liên tục quanh setpoint.
...
- I: Khi xe lên 49 km/h, P hầu như không còn tác dụng. (kp * error rất nhỏ) 
...
- Bước 1 : Tắt I và D  ; ki = 0 ,kd = 0 , kp > 0 -> ổn định hệ thống trước
...
- Tại một giá trị nào đó, hệ thống bắt đầu:
- 49.0° → 51.0° → 49.0° → 51.0° → lặp lại mãi
- duty : 42% → 60% → 42% → 60% → 42% → ...

- Thời điểm này gọi là: Kp_crit (Kp tới hạn) ,Tu = chu kỳ dao động (thời gian giữa 2 đỉnh)
