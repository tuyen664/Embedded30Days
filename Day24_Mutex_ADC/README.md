...
- Nếu Task_ADC giữ mutex quá lâu → Sensor bị timeout → không in ra UART
...
- Sample time dài = loại nhiễu tốt hơn nhưng tăng thời gian chuyển đổi → chỉ ok trong bài test sensor chậm
