...
- Trong code sử dụng 600µs → 2400µs để tránh rung khi chạm biên (nhiều servo bị không ổn định ở mức giới hạn).

**1. Cấu hình PWM cho TIM4_CH4 (PB9)**

- Bật clock cho GPIOB và TIM4 , bật AFIO
- Cấu hình PB9 là AF Push-Pull ,  tốc độ 50MHz
- TIM4->PSC = 72-1; // 1 tick = 1µs (TIM4 = 72MHz) : Servo cần 600 tick -> 2400 tick (TIM4->CCR4)
...
**2. Hàm chuyển Góc -> Số Tick trong TIM4->CCR4** 
...
- c đọc từng ký tự nhận về từ USART1->DR , biến i là idex của buffer  
